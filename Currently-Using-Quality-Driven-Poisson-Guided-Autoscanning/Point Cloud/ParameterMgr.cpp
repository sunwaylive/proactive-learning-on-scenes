...
//   glarea.addParam(new RichColor("Light Specular Color", QColor(255, 255, 255)));
	...
	glarea.addParam(new RichColor("Light Ambient Color", QColor(100, 100, 100)));
	glarea.addParam(new RichColor("Light Diffuse Color", QColor(100, 100, 100)));	
	glarea.addParam(new RichColor("Light Specular Color", QColor(100, 100, 100)));
...
void ParameterMgr::initPoissonParameter()
{
  ...
  poisson.addParam(new RichBool("Run Estimate Original KNN", false));
	...
	poisson.addParam(new RichDouble("Poisson Disk Sample Number", 100));
...
void ParameterMgr::initNBVParameter()
{
  ...
  nbv.addParam(new RichInt("SDF Slice Plane Resolution", 0));
}